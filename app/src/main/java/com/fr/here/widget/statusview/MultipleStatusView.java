package com.fr.here.widget.statusview;
...
public class MultipleStatusView extends RelativeLayout {
    ...
    public MultipleStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray a =
            context.obtainStyledAttributes(attrs, com.classic.common.R.styleable.MultipleStatusView, defStyleAttr, 0);

        mEmptyViewResId =
            a.getResourceId(com.classic.common.R.styleable.MultipleStatusView_emptyView, com.classic.common.R.layout.empty_view);
        mErrorViewResId =
            a.getResourceId(com.classic.common.R.styleable.MultipleStatusView_errorView, com.classic.common.R.layout.error_view);
        mLoadingViewResId =
            a.getResourceId(com.classic.common.R.styleable.MultipleStatusView_loadingView, com.classic.common.R.layout.loading_view);
        mNoNetworkViewResId = a.getResourceId(com.classic.common.R.styleable.MultipleStatusView_noNetworkView,
            com.classic.common.R.layout.no_network_view);
        mContentViewResId = a.getResourceId(com.classic.common.R.styleable.MultipleStatusView_contentView,
            NULL_RESOURCE_ID);
        a.recycle();
    }
    ...
    public final void showEmpty() {
        ...
        if(null == mEmptyView){
            ...
            mEmptyRetryView = mEmptyView.findViewById(com.classic.common.R.id.empty_retry_view);
    ...
    public final void showError() {
        ...
        if(null == mErrorView){
            ...
            mErrorRetryView = mErrorView.findViewById(com.classic.common.R.id.error_retry_view);
    ...
    public final void showNoNetwork() {
        ...
        if(null == mNoNetworkView){
            ...
            mNoNetworkRetryView = mNoNetworkView.findViewById(com.classic.common.R.id.no_network_retry_view);
    ...
    public final void showContent() {
        ...
        if(null == mContentView){
            if(mContentViewResId != NULL_RESOURCE_ID){
                ...
                mContentView = findViewById(com.classic.common.R.id.content_view);
            }
        }
        showViewByStatus(mViewStatus);
    }
