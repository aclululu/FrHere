package com.fr.here.widget.loadanim;
...
public class AVLoadingIndicatorView extends View {
    ...
    private void init(Context context,AttributeSet attrs,int defStyleAttr, int defStyleRes) {
        ...
        String indicatorName=a.getString(R.styleable.AVLoadingIndicatorView_avindicatorName);
        int indicatorColor=a.getColor(R.styleable.AVLoadingIndicatorView_avindicatorColor, Color.WHITE);
