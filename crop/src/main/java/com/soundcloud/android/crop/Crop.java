...
import com.soundcloud.android.crop.support.SelectPictureActivity;
...
public class Crop {
    ...
    public static void pickImage(Activity activity, int requestCode) {
        try {
            activity.startActivityForResult(getImagePicker(activity), requestCode);
    ...
    public static void pickImage(Context context, Fragment fragment, int requestCode) {
        try {
            fragment.startActivityForResult(getImagePicker(context), requestCode);
        } catch (ActivityNotFoundException e) {
    ...
    /**
     * 这里可以选择启动自定义的图片选择器还是系统的
     * @param context
     * @return
     */
    private static Intent getImagePicker(Context context) {
